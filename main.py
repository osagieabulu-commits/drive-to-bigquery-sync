...
TABLE_KEY_COLUMNS = {
    ...
    'retail_open_tickets': ['conversation_id', 'ticket_created_africa_algiers_'],
    'k4b_open_tickets': ['conversation_id', 'ticket_created_africa_algiers_'],
    'k4b_open_conversations': ['conversation_id', 'conversation_started_at_africa_algiers_'],
    'retail_open_conversations': ['conversation_id', 'conversation_started_at_africa_algiers_'],
